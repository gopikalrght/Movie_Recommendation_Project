...
from backend.data_layer.database import (
    init_db,
    get_watchlist_db,
    add_movie_db,
    get_movie_by_title_db,
    delete_movie_db
)

from backend.data_layer.omdb_api import (
    search_movies,
    get_movie_details
)
...
@app.route('/movie/<string:imdb_id>', methods=['GET'])
...
def delete_watchlist(title):
    ...
    try:
        ...
        # Flask automatically decodes the URL path
        existing_movie = get_movie_by_title_db(title)
